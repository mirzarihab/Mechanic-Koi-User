            ...
            Positioned(
              ...
              child:  RaisedButton(
                  ...
                  child: Row(
                    children: <Widget>[
                      Icon(Icons.search),
                      Text(" Search Mechanic",style: TextStyle(fontSize: 15),)
                    ],
  ...
  checkPoint(){
    ...
    databaseReference
      ...
      snapshot.documents.forEach((f) => Firestore.instance
        ...
        mech = Point(_userdata['Latitude'], _userdata['Longitude']);
        print(mech);
      //  print("cxccvvvvvvvvvvvvvvvvvvv");
  ...
  meckCheck(Point in1) {
    ...
    print(av);
     if(mLoc==true){
       ...
       databaseReference.child('fcm-token/${_userdata['Token']}').set({"uid": av});
       textValue = _userdata['Token'];
      // sendNotification();
...
/*  getMdata() async {
  ...
  sendNotification(){
    ...
    DatabaseReference databaseReference = new FirebaseDatabase().reference();
    databaseReference.child('notification/${_userdata['Token']}').set({"token": _userdata['Token']});
    textValue = _userdata['Token'];
