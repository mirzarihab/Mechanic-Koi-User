...
//getData();
        ...
        child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 10.0,),
                buildTextField5("Car Name & Model"),
                SizedBox(height: 10.0,),
  ...
  recordData()async{
    print(dtoken);
    await databaseReference.collection("User Data")
        .document(user2.uid)
        .setData({
      'Name':  _name,
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: hintText == "Car Name & Model" ? Icon(Icons.email) : Icon(Icons.lock),
          suffixIcon: hintText == "Password"  ? IconButton(
            onPressed: _toggleVisibility,
            icon: _isHidden ? Icon(Icons.visibility_off) : Icon(Icons.visibility),
          ):hintText == "Confirm Password"  ? IconButton(
